...
public class SwaggerTestController {
    ...
    /* 회원 상세 조회 */
    @Operation(summary = "회원번호로 회원 조회", description = "회원 번호를 통해 해당하는 회원정보를 조회한다.")
    ...
    public ResponseEntity<?> medifyUser(@PathVariable int userNo, @RequestBody UserDTO modifyInfo) {
